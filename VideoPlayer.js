...
export default class VideoPlayer extends Component {
  ...
  hideControlAnimation() {
    Animated.parallel([
      ...
      Animated.timing(this.animations.playPause.opacity, { toValue: 0 }),
  ...
  showControlAnimation() {
    Animated.parallel([
      ...
      Animated.timing(this.animations.playPause.opacity, { toValue: 1 }),
  ...
  renderBottomControls() {
    const currentTimeControl = !this.props.disableCurrentTime
      ? this.renderCurrentTime()
      : this.renderNullControl();
    const timeRemainingControl = !this.props.disableTimeRemaining
  ...
  renderPlayPause() {
    let source =
      this.state.paused === true
        ? require("./assets/img/play_3.png")
        : require("./assets/img/pause_3.png");
    return this.renderControl(
      <Animated.View
        style={[
